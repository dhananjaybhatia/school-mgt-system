      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-blue py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
                src="https://images.pexels.com/photos/1326946/pexels-photo-1326946.jpeg"
                alt=""
                width={144}
                height={144}
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-semibold">Alia Bhat</h1>
              </div>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            <div className="w-full p-4 rounded-md flex gap-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%] bg-white">
              <Image
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            ...
            <Link className="p-3 rounded-md bg-yellow" href={"/"}>
              Student&apos;s Lessons
            </Link>
            <Link className="p-3 rounded-md bg-green" href={"/"}>
              Student&apos;s Exams
            </Link>
